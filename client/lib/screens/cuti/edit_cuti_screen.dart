...
class EditCutiScreen extends StatefulWidget {
  ...
  const EditCutiScreen({Key? key, required this.employeeModel})
      : super(key: key);
...
class _EditCutiScreenState extends State<EditCutiScreen> {
  ...
  @override
  void initState() {
    idC.text = widget.employeeModel.id.toString();
    nameC.text = widget.employeeModel.name;
    positionC.text = widget.employeeModel.position;
    birthPlaceC.text = widget.employeeModel.birthPlace;
    birthDateC.text = widget.employeeModel.birthDate;
    leaveBalanceC.text = widget.employeeModel.leaveBalance.toString();
    if (widget.employeeModel.imgPath != null) {
      imgFile = File(widget.employeeModel.imgPath!);
    }
    super.initState();
  }
        ...
        leading: GestureDetector(
            onTap: () {
              Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      DetailsCutiScreen(employeeModel: widget.employeeModel),
                ),
              );
            },
            child: const Icon(
